...
\begin{tikzpicture}[remember picture, overlay] 
  ...
  \end{tikzpicture}%
\centerline{\LARGE\bfseries{刘淇}} 

\centerline{\normalsize{\faPhone\ 139-2302-6440 \quad \faEnvelopeO\ \href{mailto:lq09270226@126.com}{lq09270226@126.com}}} 
    
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景}    
\textbf{广东药科大学} \hfill 2021.9 -- 2025.6\\[0.5em] % 标题和正文间加一点距离
高分子材料与工程\quad 已毕业 
\begin{itemize}[nosep]
    \item 相关课程：《高分子材料》、《高分子化学》、《高分子物理》
\end{itemize}

\textbf{广东工业大学} \hfill 2025.9 -- 至今\\[0.5em] % 标题和正文间加一点距离
材料工程\quad 研究生一年级 
\begin{itemize}[nosep]
    \item 相关课程：《现代电化学》、《现代化学电源》、《微纳结构材料》
\end{itemize}
...
\textbf{98烂坑风控与可视化作战平台} \hfill 2024.09 -- 至今 \titlebreak
